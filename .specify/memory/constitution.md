<!--
Sync Impact Report:
- 헌법 버전: 1.6.0 (소프트웨어 개발 원칙 및 의존성 관리 정책 추가)
- 수정 내용:
  - 2026-03-15: IV. 엔지니어링 표준에 '소프트웨어 개발 원칙 (KISS, YAGNI, DRY, SRP)' 명시.
  - 2026-03-15: III. 기술 표준에 '의존성 관리 (Dependency Management)' 정책 추가 (패키지 설치 시 ~= 등을 사용하여 버전 고정).
- 업데이트 확인 템플릿:
...
**버전**: 1.6.0 | **비준일**: 2026-03-12 | **최종 수정일**: 2026-03-15
