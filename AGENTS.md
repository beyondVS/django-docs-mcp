...
*   **공식 문서 수집 표준**: Django 공식 문서 및 관련 가이드는 렌더링된 웹페이지(HTML)를 직접 크롤링하여 링크 정합성과 구조적 완전성이 보장된 고품질 마크다운을 확보합니다. 수집 시 `BaseCrawler` 공통 엔진 기반의 도구(`django52_crawler.py`, `orm_cookbook.py` 등)를 사용하며, 내부 링크 및 이미지는 자동으로 절대 URL로 보정됩니다.
