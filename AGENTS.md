...
*   **공식 문서 수집 표준**: Django 공식 문서와 같은 RST 기반 소스는 `git sparse-checkout`을 통해 필요한 디렉토리만 효율적으로 수집하며, `docutils` 및 Sphinx 확장 구문을 지원하는 `rst_converter.py`를 사용하여 마크다운으로 변환합니다.
