...
> **핵심 설계 결정 및 전략적 전환 사유를 기록합니다.**

| 전략적 최적화 (Strategy) | 결정 근거 | 대안(RST) 미채택 사유 |
|-----------|------------|---------------------------|
| **수집 원본 고도화 (RST -> HTML)** | 렌더링된 HTML 수집을 통해 100% 유효한 절대 링크와 완전한 문서 구조를 확보하여 RAG 검색 품질을 극대화함. | 기존 RST 소스는 변환 과정에서의 링크 누락 및 복잡한 지시어 처리의 한계로 인해 최종 데이터 품질 확보가 어려움. |
