...
**언어/버전**: Python 3.14 (Type 준수 의무)
**주요 의존성**: `httpx` (Async HTTP Client), `readability-lxml` (Content Extraction), `markdownify` (HTML to MD), `PyYAML` (Metadata)
...
**규모/범위**: Django 2.x 기반 Cookbook 문서 전체 수집 및 변환
