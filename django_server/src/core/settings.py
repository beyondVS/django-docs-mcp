...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY", "django-insecure-i3@d6f1@)5&5!9p9+gz*x#ce)-2px^7dd(i)5*26n4_@lw0v2^"
)
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "django_docs"),
...
# .env의 LOG_LEVEL을 통해 제어 가능 (기본값: WARNING)
