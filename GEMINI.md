...
모든 기능 계획서에서 자동 생성되었습니다. 최종 업데이트: 2026-03-25
...
- Python 3.13 + `fastmcp==3.1.1` (008-mcp-server-implementation)
- PostgreSQL (ParadeDB) Integrated Search (008-mcp-server-implementation)
...
## 최근 변경 사항
- 008-mcp-server-implementation: Added FastMCP 3.1.1 Serving Architecture (Python 3.13)
